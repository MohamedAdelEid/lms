...
<div class="container-fluid bg-secondary-dark pb-7">
    <div class="container-fluid">
        <div class="card bg-primary-dark">
            <div class="card-body">
                <h5 class="card-title fw-semibold text-mode mb-3">Edit User</h5>
                <hr>
                @if(session('success'))
                ...
                @endif
                <form method="POST" action="{{route('edit.editUser', ['id' => $currentUserData->id])}}" >
                    @csrf
                    @method('PUT')
                    <div class="card-body row justify-content-between">
                        <div class="col-xl-6 col-lg-6 col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="name" placeholder="Name" value="{{$currentUserData->name}}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="email" placeholder="E-mail" value="{{$currentUserData->email}}"  name="email" class="form-control  @error('email') is-invalid @enderror" id="email">
                                @error('email')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" placeholder="Phone Number" name="phone_number" value="{{$currentUserData->phone_number}}"
